...
request = RestClient::Request.new(
    method: :post,
    url: "http://68.183.197.37:3000/tts/uploadvtt/#{meeting_id}",
    payload: { :file => File.open('/home/ubuntu/Downloads/6e35e3b2778883f5db637d7a5dba0a427f692e91-1569435655142_1570639035198.vtt', 'rb'),
